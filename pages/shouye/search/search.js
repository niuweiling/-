...
Page({
  ...
  onLoad: function (options) {
    ...
    this.setData({ hisCompany: JSON.parse(hisCompany.split('http').join('https').split('***').join('?').split('###').join('=')) });
  ...
  //   console.log("获取缓存数据:" + cachetarry);

  //   cachetarry.push('一汽财务有限公司');
  //   //testarry.splice(id,i)就可以从index为id的位置开始，删除i个元素
